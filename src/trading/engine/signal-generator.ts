  ...
  async generateSignal(params: {
    ...
    const positionResult = calculatePositionSize(
      ...
      },
      {
        ...
        maxLeverage: 75,
        leverageTiers: [
          { minConfidence: 95, minStrength: 85, leverage: 75 },
          { minConfidence: 85, minStrength: 70, leverage: 50 },
          { minConfidence: 75, minStrength: 60, leverage: 40 },
          { minConfidence: 70, minStrength: 50, leverage: 30 },
        ],
        dailyLossLimit: 15,
        maxDrawdown: 30,
        maxPositions: 2,
