-- ============================================================
-- MANUAL MIGRATION - Run in Supabase Dashboard SQL Editor
-- ============================================================
-- Generated: 2026-02-16
-- This script applies the missing migrations to complete schema v2.4
--
-- Run this at: https://supabase.com/dashboard/project/YOUR_PROJECT_ID/sql/new
-- ============================================================
...
VALUES (
  'schema_migration',
  'Manual migration applied - columns, tables, and RPCs',
  '{"version": "manual_apply_now", "applied_at": "2026-02-16"}'::jsonb
